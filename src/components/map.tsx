...
import { HouseDistinctFieldEnum } from "@prisma/client";
...
export default function Map({ setDataBounds, houses, highlightedId}: IProps) {
  ...
  const [viewport, setViewport] = useLocalState<ViewState>("viewport", {
      latitude: 5.3697,       // use cameroon's 7.3697
      longitude: 12.3547,     // use Cameroon's 12.3547
      zoom: 10,           
  });
  ...
  return (
    <div className="text-black relative">
      <ReactMapGL
        ...
        }}                   // need to put our own style map creation
